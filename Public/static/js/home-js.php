 ...
 * home-js.php
 * 
 * FoatingRepo js for the Home page.
 *
 ...
 */
 ...
 $BUD_NAME=filter_input(INPUT_GET, "av")??"";
 $BUD_NAME = strip_tags($BUD_NAME);
...
function setGallery1On() {
  $(".gallery1").css("background","url(/res/gallery1.png)");
  $(".gallery1").css("background-size","120px 120px");
  $(".gallery1").css("border-radius","55px");
  document.getElementsByClassName("gallery1")[0].onclick=setGallery1Off;
  document.getElementById("txtGallery1").value="1";
  document.getElementById("frmUpload").submit();
}

function setGallery1Off() {
  $(".gallery1").css("background","url(/res/gallery1dis.png)");
  $(".gallery1").css("background-size","120px 120px");
  $(".gallery1").css("border-radius","55px");
  document.getElementsByClassName("gallery1")[0].onclick=setGallery1On;
  document.getElementById("txtGallery1").value="0"; 
  document.getElementById("frmUpload").submit();
}
...
function changeLang(tthis) {
  window.open("/<?PHP echo($BUD_NAME);?>?hl="+$(tthis).val(),"_self");
}
